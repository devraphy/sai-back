...
//    void findByFriend() {
//        //given
//        List<Friend> friendList = em.createQuery("select f from Friend f where f.owner = :owner and f.type = :relationType", Friend.class)
//                .setParameter("owner", owner)
//                .setParameter("relationType", RelationType.FRIEND).getResultList();
//
//        List<Friend> businessList = em.createQuery("select f from Friend f where f.owner = :owner and f.type = :relationType", Friend.class)
//                .setParameter("owner", owner)
//                .setParameter("relationType", RelationType.BUSINESS).getResultList();
//
//        //when
//        List<Event> friendEventList = eventRepository.findByParticipants(friendList);
//        List<Event> businessEventList = eventRepository.findByParticipants(businessList);
//
//        //then
